import { type Associativity, type BindingPower, BindingPowers } from '../../ast';
import {
		...
		case TokenKinds.CANVAS: {
			...
			if (elements.length !== 2)
				throw parser.TuberParserError(
					`Se esperaban 2 expresiones separadas por coma (ancho, alto) luego del indicador de tipo: \`${literal.translated}\``,
				);
