import type { PSCanvas } from './constructs/psCanvas';
...
import type { PSUser } from './constructs/psUser';
...
export abstract class EnvironmentProvider {
	//NO volver una interfaz. Por lo que he visto, hay un problema en runtime al resolver el import de interfaces particularmente en "implements"
	...
	abstract createCanvas(width: number, height: number): PSCanvas;
}
